...
dijamin unik oleh timestamp (`arsitektur-sistem-photobooth.md:65`), jadi tabrakan nama
tidak merusak data — yang rusak adalah pencarian di Riwayat berbulan-bulan kemudian.
